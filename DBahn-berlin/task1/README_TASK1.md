...
Außerdem muss der PK aus der Stop ID (<s id="..."> im XML) **und** der XML Nummer (bspw. '2509260400/berlin-westkreuz_timetable.xml') erfolgen. Das Problem ist nämlich, dass die Stop ID nicht über alle XML Dateien unique ist.
